...
感谢 **1715141478@qq.com** 开发的 **SimpleKalimba1.0 APK** 项目。本项目是在参考其 UI 和功能的基础上，按照本人的偏好进行的重构；在联系不上原作者的情况下，通过 **Vibe Coding** 的方式，实现了部分音色自由、曲库自由。

本项目曲库一部分来自 SimpleKalimba，新加入部分是根据简谱转化而来的 MIDI，如《义勇军进行曲》。若原作者对内容有异议，欢迎通过仓库 Issues 联系本人，将配合署名或移除。
